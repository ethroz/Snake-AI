...
static class Program
{
    ...
    private static char[] snakeChars = new char[NUM_COMP] { '█', '▓', '▒', '░' };
    ...
    private static void Main()
    {
        ...
        if (TRAIN)
        {
            ...
            WeightsFile = Path.GetDirectoryName(WeightsFile);
            WeightsFile += "\\Weights ";
            ...
            // If there are weights to get things from.
        ...
        else
        {
            ...
            Console.WindowHeight = Board.y;
            Console.WindowWidth = Board.x;
            ...
            do
            {
                ...
                while (score != SnakeGame.WIN_SCORE)
                {
                    ...
                    if (Input == ConsoleKey.W)
                        ...
                        break;
                    if (newDir != new Int2() && 
                        newDir + snakeGame.Snakes[0].Dir != new Int2())
                        snakeGame.Snakes[0].Dir = newDir;
